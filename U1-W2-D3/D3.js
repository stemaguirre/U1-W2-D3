...
console.log('questi sono i personaggi di Star Wars', characterNames)
...
for (i = 0; i < starWarsCharacters.length; i++) {
  while (starWarsCharacters.mass <= 277) {
    crewMass = starWarsCharacters.mass += 1
    crewMass++
  }
}
...
for (i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters.gender === 'n/a')
    starWarsCharacters.gender.splice(length - 1, 0, 'robot')
}
